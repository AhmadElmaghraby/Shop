 ...
 * @author compucare
 */
public class AddProductTwoPanel extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean b = false;
        if (in == 0) {
            b = pc.AddProduct_in(productId, jTextFieldBuyPrice.getText(), jTextFieldِamount.getText());
        } else if (in == 1) {
            b = pc.AddProduct_out(productId, jTextFieldBuyPrice.getText(), jTextFieldِamount.getText());
        }
        if (b) {
